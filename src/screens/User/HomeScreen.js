...
import {View,Image,StyleSheet,Alert,ScrollView,FlatList,TouchableOpacity,Linking,RefreshControl} from 'react-native';
...
fetachNews(1);
    ...
    var fetachNews = (pageNum)=>{
      axios.get('http://newsapi.org/v2/'+SerachType, {
          params: {
              q:search,
              from:'2021-02-02',
              sortBy:'publishedAt',
            ...
            return (
              ...
              onPress={()=>{
                ...
                <Image
                   ...
                   style={{resizeMode:'contain',height:'100%',width:'70%',borderRadius: 5,
                   height: 100,
                   padding: 30,
                   marginLeft: 25,
                   marginRight: 25}}
            ...
            alignItems:'center'}}>
                ...
                <Item style={{
                  ...
                  fontSize:4
                    ...
                    <Input placeholder={t('Search')} value={search} onChangeText={(value)=>{
                      if(value != ''){
                        setSearch(value);
                    ...
                    }} onSubmitEditing={()=>{setUpdate(!update)
                      setCurrentData([]);
                      setFeatched(true)
                        ...
                        onEndReachedThreshold={0.8}
                            ...
                            renderItem={({ item }) => (
                                <TouchableOpacity onPress={()=>{
                                    navigation.navigate('SingleScreen',{item:JSON.stringify(item),id:0})
                                }}
                                                  activeOpacity={.95}
                                >
